...
Filesystem overlap만 충돌은 아닙니다. Claim은 정책, scenario, contract, DB entity, migration slot, UI flow, dependency major, stable ID, root pointer도 예약합니다. 충돌 발견은 조용한 병렬 수정을 막고 ownership·boundary·sequence를 합의하게 하며 자동 reset·stash·rebase를 하지 않습니다.
