...
4. Summarize confirmed facts, stale derivations, unknown external state, blockers, active ownership, and local-only work. Explain whether ownership came from the external provider, the recoverable Git reservation, or both. Do not expose IDs or internal storage paths unless diagnosing them is necessary.
